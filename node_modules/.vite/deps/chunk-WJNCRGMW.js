...
var ICONS = {
  add: async () => (await import("./add-ER4NUL2J.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-GYPDFJIA.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-YEUWDQEF.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-5EB3HXTF.js")).appStoreSvg,
  apple: async () => (await import("./apple-HFP6AVXK.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-YZI42SW3.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-5ZEZLF4A.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-SG7FEWTE.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-DN3Y7KK4.js")).arrowTopSvg,
  bank: async () => (await import("./bank-24B7AD7O.js")).bankSvg,
  browser: async () => (await import("./browser-CVBPBGVE.js")).browserSvg,
  card: async () => (await import("./card-PP3WOFIK.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-ZJMCLVD3.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-A5DXWGTZ.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-RQEOPMD5.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-INCDG3V3.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-HYROQ7X4.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-TPTNXNQI.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-KAPUNHNG.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-BF53O7DK.js")).clockSvg,
  close: async () => (await import("./close-27IECT6M.js")).closeSvg,
  compass: async () => (await import("./compass-FMJWTAAS.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-QCTIRM2M.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-D2BLK6SK.js")).copySvg,
  cursor: async () => (await import("./cursor-3DWISCWY.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-FBPWQ6H5.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-OE6PYBS2.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-RIB7ON2S.js")).disconnectSvg,
  discord: async () => (await import("./discord-BGZPMUG6.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-F6QT46VS.js")).etherscanSvg,
  extension: async () => (await import("./extension-I5TVGWZX.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-CVFY2FQK.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-PIBO4XXQ.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-63X5KPV5.js")).farcasterSvg,
  filters: async () => (await import("./filters-JU2VZJBV.js")).filtersSvg,
  github: async () => (await import("./github-3COQUSIX.js")).githubSvg,
  google: async () => (await import("./google-AIALNDHP.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-ARHMLUER.js")).helpCircleSvg,
  image: async () => (await import("./image-MY6KB3J6.js")).imageSvg,
  id: async () => (await import("./id-FFBBUQXM.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-UOBQKOVA.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-BX4T3JON.js")).lightbulbSvg,
  mail: async () => (await import("./mail-S52YVU3Y.js")).mailSvg,
  mobile: async () => (await import("./mobile-RWRD2KSQ.js")).mobileSvg,
  more: async () => (await import("./more-ZT3XOYDN.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-MOR4LEPH.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-37DTIQ4M.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-JBLOVDVN.js")).offSvg,
  playStore: async () => (await import("./play-store-V3WX5FPD.js")).playStoreSvg,
  plus: async () => (await import("./plus-4SXYNGMW.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-C2TLS3VT.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-VXGEFJYB.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-DNY26T5L.js")).refreshSvg,
  search: async () => (await import("./search-AYUOOK4R.js")).searchSvg,
  send: async () => (await import("./send-OTLNHRQG.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-BMUTMSD2.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-MVVNN6VX.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-PKIZOHAT.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-S6P6Q4XJ.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-3XRIWV6Q.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-ENXW3HHH.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-EWGQUS47.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-5C67ZZHP.js")).twitchSvg,
  twitter: async () => (await import("./x-HFNXFZU3.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-Q6XQZB7H.js")).twitterIconSvg,
  verify: async () => (await import("./verify-2LVF62DN.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-Y4EF44BW.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-UX45P3DH.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-4NQAYKGQ.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-4NQAYKGQ.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-4NQAYKGQ.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-RUA5YEXI.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-G7YVADWV.js")).warningCircleSvg,
  x: async () => (await import("./x-HFNXFZU3.js")).xSvg,
  info: async () => (await import("./info-DC6NT6RF.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-EW2OKQPI.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-6ULXARKR.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-WJNCRGMW.js.map
